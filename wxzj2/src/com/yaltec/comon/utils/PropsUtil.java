...
public abstract class PropsUtil {
    ...
    /**
     * Check system properties first, before trying the specified properties. This allows system properties to override any
     * other property source.
     */
    public static final int SYSTEM_PROPERTIES_MODE_OVERRIDE = 2;

    protected int systemPropertiesMode = SYSTEM_PROPERTIES_MODE_NEVER;

    protected Properties p;

    public PropsUtil(Properties p) {
        setProperties(p);
    }

    public PropsUtil(Properties p, int systemPropertiesMode) {
        setProperties(p);
    ...
    protected static boolean isBlankString(String value) {
        return value == null || "".equals(value.trim());
    }

    protected static String[] tokenizeToStringArray(String str, String seperators) {
    ...
    protected static int[] toIntArray(String[] array) {
