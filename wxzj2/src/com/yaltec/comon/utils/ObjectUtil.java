...
public abstract class ObjectUtil {
    ...
    /**
     * 判断给定的参数对象是否为null或者内部元素为空;<br/> 当null==obj或0==size或0==length, 则直接返回 true.
     * 
     * @param obj 对象实例.
    ...
    /**
     * 获取对象内部元素的个数;<br/> 当null==obj, 则直接返回 0;<br/> 当obj为集合对象（Collection、Map）, 则返回 size;<br/> 当obj数组或字符串, 则返回 length;
     * 当obj为其他类型, 则返回 1.<br/>
     * 
     * @param obj 对象实例.
    ...
    /**
     * 清空对象内容（集合的元素）;<br/> 当null==obj, 则直接返回 0;<br/> 当obj为集合对象（Collection、Map）, 则返回 size;<br/> 当obj数组或字符串, 则返回 length;
     * 当obj为其他类型, 则返回 1.<br/>
     * 
     * @param obj 对象实例.
     */
    ...
    /**
     * 获取对象16进制的HashCode;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
    ...
    /**
     * 克隆对象(深度克隆);<br/> 当null==obj, 则直接返回null.
     * 
     * @param <T> 指定克隆的接收类型.
     * @param obj 对象实例.
     * @return Object 对象副本.
    ...
    /**
     * 将对象转换成Character类型;<br/> 当null==obj, 则直接返回null.
     * 
     * @param obj 对象实例.
     * @return Character类型值.
     */
    ...
    /**
     * 将对象转换成Character类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Character类型值.
    ...
    /**
     * 将对象转换成String类型;<br/> 当null==obj, 则直接返回"&ltNULL&gt".
     * 
     * @param obj 对象实例.
     * @return String类型值.
     */
    ...
    /**
     * 将对象转换成String类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return String类型值.
    ...
    /**
     * 将对象转换成Byte类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Byte类型值.
     */
    ...
    /**
     * 将对象转换成Byte类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Byte类型值.
    ...
    /**
     * 将对象转换成Boolean类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Boolean类型值.
     */
    ...
    /**
     * 将对象转换成Boolean类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Boolean类型值.
    ...
    /**
     * 将对象转换成Short类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Short类型值.
     */
    ...
    /**
     * 将对象转换成Short类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Short类型值.
    ...
    /**
     * 将对象转换成Integer类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Integer类型值.
     */
    ...
    /**
     * 将对象转换成Integer类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Integer类型值.
    ...
    /**
     * 将对象转换成Long类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Long类型值.
     */
    ...
    /**
     * 将对象转换成Long类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Long类型值.
    ...
    /**
     * 将对象转换成Float类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Float类型值.
     */
    ...
    /**
     * 将对象转换成Float类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Float类型值.
    ...
    /**
     * 将对象转换成Double类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Double类型值.
     */
    ...
    /**
     * 将对象转换成Double类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Double类型值.
    ...
    /**
     * 将对象转换成BigDecimal类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
    ...
    /**
     * 将对象转换成BigDecimal类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return BigDecimal类型值.
    ...
    /**
     * 将对象转换成Date类型;<br/> 当null==obj, 则直接返回 null.
     * 
     * @param obj 对象实例.
     * @return Date类型值.
     */
    ...
    /**
     * 将对象转换成Date类型;<br/> 当null==obj, 则直接返回 _default.
     * 
     * @param obj 对象实例.
     * @param _default 缺省值.
     * @return Date类型值.
