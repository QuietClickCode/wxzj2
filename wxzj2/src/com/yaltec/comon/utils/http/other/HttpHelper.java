...
public class HttpHelper {
    ...
    private static void setParams(String url, HttpClientWrapper hw) {
        ...
        for (String param : paramArray) {
            if (param == null || _Util.EMPTY_STR.equals(param.trim())) {
                continue;
            }
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (value instanceof File) {
                    ...
                    if (value != null && !_Util.EMPTY_STR.equals(value)) {
                        hw.addNV(key, String.valueOf(value));
                    } else {
                        hw.addNV(key, _Util.EMPTY_STR);
                    }
                }
            }
    ...
    public static void testUploadFile() {
        try {
            String url = "http://127.0.0.1/ifirefly/comon/upload.htm";
            Map<String, Object> paramsMap = new HashMap<String, Object>();
            paramsMap.put("userName", "jj");
            paramsMap.put("password", "jj");
            paramsMap.put("filePath", new File("D:\\Backup\\Desktop\\captcha.jpg"));
