...
public class SessionManager {
	...
	/**
	 * 根据accountKey 获取 sessionMap，<br/>
	 * 如果对应的sessionKey不存在，则返回null。
	 * 
	 ...
	 * 追加Session
	 * <desc>
	 * author charis.peng@gmail.com 此处必须带上";"号结尾,因为
     * getSessionByMap调用转化成字符串时以";"为区分,cookie中设置的sessionID必须有";"间隔
     * </desc>
     * 
	 * headers
	 * @param headers
	...
	public static boolean isExistSession(String accountKey) {
		...
		return !ObjectUtil.isEmpty(sessionMap);
	}
