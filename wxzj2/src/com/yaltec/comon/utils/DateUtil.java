...
public abstract class DateUtil {
    ...
    /**
     * 年月日时分秒毫秒字符串 格式模板:yyyyMMddHHmmssSSS
     */
    public static final String CURR_TIME_STAMP = "yyyyMMddHHmmssSSS";
    /**
    ...
    /**
	 * 对指定日期加减计算 返回日期字符串
	 * @param String dateStr 传入的原日期字符串
	 * @param int year_count 加减的年数
	 * @param int method_count 加减的月数
	 * @param int day_count 加减的天数
	 * @param boolean flag 返回日期字符串的格式，true：yyyy-MM-dd，false：yyyy-MM-dd HH:mm:ss
	 * @return String 日期字符串
	 * */
	public static String add(String dateStr, int year_count, int method_count, int day_count, boolean flag) {
		...
		calendar.add(Calendar.YEAR, year_count);
		calendar.add(Calendar.MONTH, method_count);
		calendar.add(Calendar.DATE, day_count);
