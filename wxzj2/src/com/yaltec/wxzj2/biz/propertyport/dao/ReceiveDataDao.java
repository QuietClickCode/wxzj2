...
public interface ReceiveDataDao {
	 ...
	 * @return
	 */
	public void addXQ(Map<String, Object> map);
	/**
	 * 小区数据关联
	 * @param map
	 * @return
	 ...
	 * @return
	 */
	public void addLY(Map<String, Object> map);
	/**
	 * 楼宇数据关联
	 * @param map
	 * @return
	 ...
	 * @return
	 */
	public void receiveFW(Map<String, Object> map);
	/**
	 * 执行传入的sql语句
	 * @param parasMap
	 * @return
	 ...
	 * @return
	 */
	public void syncFW(Map<String, Object> map);
}
