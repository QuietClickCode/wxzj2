...
/**
 * 
 * @ClassName: CancelAuditExport
 * @Description: 撤销审核(已审核)数据导出
 * 
 * @author yangshanping
 * @date 2016-9-13 上午09:16:11
 */
public class CancelAuditExport {
	...
	// 撤销审核数据导出
	public static void exportReviewCertificate(List<ReviewCertificate> list,
			HttpServletResponse response) throws IOException {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			ReviewCertificate ad = (ReviewCertificate) list.get(i);
