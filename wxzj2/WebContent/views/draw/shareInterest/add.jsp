	...
	<body>
		<div class="place"><span>位置：</span>
			<ul class="placeul">
				<li><a href="#">首页</a></li>
				<li><a href="#">支取业务</a></li>
				<li><a href="#">增加业主利息收益分摊</a></li>
			</ul>
		</div>
		<div class="formbody">
		    <div style="margin:0 auto; width:1000px;">
		   	  <form id="form" method="post" action="<c:url value='/shareInterest/add'/>">
		       <table style="margin: 0; width: 100%">
		        ...
		        <td style="width: 7%; text-align: center;">交款摘要</td>
		        	<td style="width: 18%">
		            	<select name="jkzy" id="jkzy" class="select" style="padding-bottom: 1px;padding-top: 1px">
								<option value="03">
									收益分摊
								</option>
						</select>
