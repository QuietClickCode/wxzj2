		    	...
		    	$(function () {
		    		$table.bootstrapTable({
						...
						},
						{
		                    ...
		                    align: 'center',
		                    formatter:function(value,row,index){  
				                var e = '<a href="#" class="tablelink" mce_href="#" onclick="agree(\''+ row.bm + '\')">审批通过</a>&nbsp;&nbsp;'; 
				                var d = '<a href="#" class="tablelink" mce_href="#" onclick="returnCheckAD(\''+ row.bm + '\')">审批退回</a>';  
				                return e + d;  
		                	}
						}],
