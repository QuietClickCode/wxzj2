...
<html lang="zh-CN">
	...
	<body>
		...
		<div id="toolbar" class="btn-group">
	   		...
	   		<button id="btn_add" type="button" class="btn btn-default" onclick="batchDel()">
	...
	<script type="text/javascript">
		    ...
		    oTableInit.Init = function () {
		    	$(function () {
		    		$table.bootstrapTable({
						url: "<c:url value='/receiveBill/list'/>",  // 请求后台的URL（*）
		...
		// 跳转新增页面
		function toAdd(){
			window.location.href = "<c:url value='/receiveBill/toAdd'/>";
		}	

		// 编辑方法
		function edit(bm) {
			window.location.href="<c:url value='/receiveBill/toUpdate?bm='/>"+bm;
		}	
		...
		function batchDel() {
			...
			if (bms == null || bms == "") {
				...
				art.dialog.confirm('你确定要删除选中的'+i+'条数据吗？', function() {
					var url = "<c:url value='/receiveBill/batchDelete?bms='/>"+bms;
			        location.href = url;
				});
			}
		}
