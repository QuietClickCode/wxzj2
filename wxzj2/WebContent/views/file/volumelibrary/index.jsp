...
<html lang="zh-CN">
			...
			<form action="" method="post" id="myForm">
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					<tr class="formtabletr">
						<td style="width: 7%; text-align: center;">卷库号</td>
						<td style="width: 18%">
							<input name="vlid" id="vlid" type="text" class="dfinput" " style="width: 202px;"/>
						</td>
						<td style="width: 7%; text-align: center;">卷库名称</td>
						<td style="width: 18%">
							<input name="vlname" id="vlname" " type="text" class="dfinput" style="width: 202px;"/>
						</td>
						<td>
	...
	<script type="text/javascript">
		    ...
		    oTableInit.Init = function () {
		    	$(function () {
		    		$table.bootstrapTable({
						url: "<c:url value='/volumelibrary/list'/>",  // 请求后台的URL（*）
		...
		function toAdd(){
			var id="";
			window.location.href="<c:url value='/volumelibrary/toSave?id="+id+"'/>";
		}
		...
		// 编辑方法
		function edit(id) {
			var url = "<c:url value='/volumelibrary/toSave?id="+id+"'/>";
	        location.href = url;
		}
		...
		function del(id) {
			art.dialog.confirm('是否删除当前记录?',function(){                       
				var url = "<c:url value='/volumelibrary/delete?id="+id+"'/>";
		        location.href = url;
	    	});
		}
		...
		function batchDel() {
			...
			if (ids == null || ids == "") {
				...
				art.dialog.confirm('你确定要删除选中的'+i+'条数据吗？', function() {
					var url = "<c:url value='/volumelibrary/batchDelete?ids="+ids+"'/>";
			        location.href = url;
				});
			}
		}
