...
<html>
	...
	<body>
	    ...
	    <div>
			<form action="<c:url value='/archives/add'/>" method="post" id="form" class="formbody">
				<input type="hidden" id="id" name="id">
				<table style="margin:0 auto; width:1000px;">
					<tr class="formtabletr">
						<td>案卷号<font color="red"><b>*</b></font></td>
						<td><input name="archiveid" id="archiveid" type="text" class="dfinput" /></td>
						<td>案卷名称<font color="red"><b>*</b></font></td>
						<td><input name="name" id="name" type="text" class="dfinput" /></td>
					...
					<tr class="formtabletr">
						...
						<td>编制机构</td>
						<td><input name="organization" id="organization" type="text" class="dfinput" /></td>
						<td>归卷年代</td>
						<td>
					...
					<tr class="formtabletr">
						<td>全宗号</td>
						<td>
							<input name="rgn" id="rgn" type="text" class="dfinput" />
						</td>
						<td>目录号</td>
						<td><input name="cn" id="cn" type="text" class="dfinput" /></td>
						<td>档案馆号</td>
						<td>
							<input name="aid" id="aid" type="text" class="dfinput" />
	            		</td>		
					</tr>
					<tr class="formtabletr">
						<td>保险箱号</td>
						<td>
							<input name="safeid" id="safeid" type="text" class="dfinput" />
						</td>
						<td>缩微号</td>
						<td><input name="microid" id="microid" type="text" class="dfinput" /></td>
						<td>页数</td>
						<td>
							<input name="page" id="page" type="text" class="dfinput" />
	            		</td>		
					</tr>
					<tr class="formtabletr">
						<td>凭证类别</td>
						<td>
							<input name="vouchtype" id="vouchtype" type="text" class="dfinput" />
						</td>
						<td>凭证编号(起)</td>
						<td><input name="vouchstartid" id="vouchstartid" type="text" class="dfinput" /></td>
						<td>凭证编号(止)</td>
						<td>
							<input name="vouchendid" id="vouchendid" type="text" class="dfinput" />
	            		</td>		
					</tr>
					<tr class="formtabletr">
						<td>备注</td>
						<td colspan="5">
							<input name="remarks" id="remarks" type="text" class="dfinput" />
						</td>
					</tr>
			        <tr class="formtabletr">
