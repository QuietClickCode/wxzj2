...
<html lang="zh-CN">
			...
			<form action="" method="post" id="myForm">
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					<tr class="formtabletr">
						...
						<td style="width: 18%">
							<select name="operator" id="operator" class="select">
	...
	<script type="text/javascript">
		    ...
		    oTableInit.Init = function () {
		    	$(function () {
		    		$table.bootstrapTable({
						url: "<c:url value='/syslog/list'/>",  // 请求后台的URL（*）
						...
						},
						{
							...
							formatter:function(value,row,index){ 
				                var a = '<a href="#" class="tablelink" mce_href="#" onclick="toDetail(\''+ row.id +'\')">详情</a>';
			                    return a;  
	                			}
						}],
		...
		function toDetail(id){
			artDialog.open(webPath+'/syslog/toDetail?id='+id, {                               
	            id:'detail',
	            title: "日志详情", //标题.默认:'提示'
	            top:30,
		...
		function exportData(){
            ...
            var param = "begindate="+begindate+"&enddate="+enddate+"&userid="+userid;
            window.location.href="<c:url value='/syslog/export?'/>"+param;
		}
	</script>
</html>