	...
	<body>
		<div class="place">
		    ...
		    <ul class="placeul">
			    ...
			    <li><a href="#">增加非税配置信息</a></li>
		    </ul>
	    </div>
	    <div>
			<form action="<c:url value='/fsconfig/add'/>" method="post" id="form" class="formbody">
				<table style="margin:0 auto; width:1000px;">
					<tr class="formtabletr">
						<td>编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号</td>
						<td><input name="id" id="id" type="text" class="dfinput" style="color:#9d9d9d;" value="${id }" readonly="readonly"/></td>
						<td>区&nbsp;县&nbsp;编&nbsp;&nbsp;码</td>
