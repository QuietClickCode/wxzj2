	...
	<body>
		<div class="place">
		    ...
		    <ul class="placeul">
			    ...
			    <li><a href="#">增加交存标准设置信息</a></li>
		    </ul>
		</div>
		<div>
			<form id="form" class="formbody" method="post" action="<c:url value='/deposit/add'/>">
		            ...
		            <tr class="formtabletr">
			        	...
			        	<td>
	            			<select name="xm" id="xm" class="select">
								...
								<option value="01" selected="selected">建筑面积</option>
	            			</select>
			        	</td>
			        </tr>
			        <tr class="formtabletr">
			            <td>系&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数<font color="red"><b>*</b></font></td>
			            <td><input name="xs" id="xs" type="text" maxlength="50" class="dfinput" style="width:200px;"/></td>
					</tr>
					<tr class="formtabletr">
			        	<td colspan="2">
