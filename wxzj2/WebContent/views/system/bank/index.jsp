...
<html lang="zh-CN">
			...
			<form action="" method="post" id="myForm">
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					<tr class="formtabletr">
						<td style="width: 7%; text-align: center;">银行名称</td>
						<td style="width: 18%">
							<input name="mc" id="mc" type="text" class="dfinput" value="${bank.mc}" style="width: 202px;"/>
						</td>
						<td>
	...
	<script type="text/javascript">
		    ...
		    oTableInit.Init = function () {
		    	$(function () {
		    		$table.bootstrapTable({
						url: "<c:url value='/bank/list'/>",  // 请求后台的URL（*）
		...
		// 跳转到新增页面
		function toAdd(){
			window.location.href="<c:url value='/bank/toAdd'/>";
		}
		...
		// 编辑方法
		function edit(id) {
			var url = "<c:url value='/bank/toUpdate?bm='/>"+id;
	        location.href = url;
		}
