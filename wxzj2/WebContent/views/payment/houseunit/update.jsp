...
<body>
   ...
   <div class="formbody">
     <form id="form" method="post" action="<c:url value='/houseunit/update'/>">
		    ...
		    <table style="margin: 0; width: 100%">
		        ...
		        <tr class="formtabletr">
		            ...
		            <td style="width: 18%">
		            	...
		            	<input id="lymc" name="lymc" type="text" class="fifinput" value='${house.lymc}' style="width:200px;" disabled="disabled"/>
		            </td>
		        ...
		        <tr class="formtabletr">
		            ...
		            <td style="width: 18%">
		            	<input id="h017" name="h017" type="hidden" value='${house.h017}'>
		            	<input id="h018" name="h018" type="text" class="fifinput" value='${house.h018}' style="width:200px;" disabled="disabled"/>
		            </td>
		        ...
		        <tr class="formtabletr">
		            ...
		            <td style="width: 18%">
		            	<input id="h022" name="h022" type="hidden" value='${house.h022}'>
						<input id="h023" name="h023" type="text" class="fifinput" value='${h023}' style="width:200px;"disabled="disabled"/> 
		            </td>
		        ...
		        <ul class="formIf" style="margin-left: 80px">
		            ...
		            <li><label>&nbsp;</label><input onclick="history.go(-1);" type="button" class="fifbtn" value="返回"/></li> </ul>
		    </div>
		    </form>
    	</div>					
</body>
