	...
	<script type="text/javascript">
		    	...
		    	$(function () {
		    		$table.bootstrapTable({
						...
						columns: [
							...
							{title: "产权项目编号",field: "xmbh"},
							{title: "产权项目地址",field: "F_LOCATION"},
							{title: '操作',field: 'operate',align: 'center',valign: "middle",sortable: false, 
			                    formatter:function(value,row,index){  
									var e = '<a href="#" class="tablelink" mce_href="#" onclick="add(\''+ row.xmbh +'\')">新建</a>';
		...
		function do_search() {
			$table.bootstrapTable('refresh', {
                url: "<c:url value='/propertyport/receive/plist'/>"
            });
			//$table.bootstrapTable('refresh');
		}
        ...
        //新建
        function add(xmbh) {
			var obj = $table.bootstrapTable('getRowByUniqueId', xmbh);
			art.dialog.data("obj",obj);
			art.dialog.data('isClose',1);
			art.dialog.open(webPath + 'project/open/toAdd', {
				id : 'xm',
				title : '新建项目', // 标题.默认:'提示'
