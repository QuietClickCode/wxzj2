...
<html lang="zh-CN">
			...
			<form action="" method="post" id="myForm">
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					<tr class="formtabletr">
						...
						<td style="width: 12%; text-align: center;">所属项目</td>
						<td style="width: 21%">
	...
	<script type="text/javascript">
		...
		function do_search() {
			...
			$table.bootstrapTable('refresh',{url:"<c:url value='/projectInterestF/list'/>"});
		}
		...
		function exportData(){
            ...
            window.location.href="<c:url value='/projectInterestF/exportProjectInterestF?'/>"+param;
		}
