				...
				<td>
					<table style="width: 100%;">
						...
						<tr>
							...
							<td align="left">
								<input id="item2_3" type="checkbox" name="item2_3" checked="checked" value="xj1"/><label for="item2_3">增加小计</label>
							</td>
						</tr>
						<tr>
							<td align="left">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="item2_4" type="checkbox" name="item2_4" checked="checked" value="z004"/><label for="item2_4">减少本金</label>
							</td>
							<td align="left">
								&nbsp;&nbsp;&nbsp;&nbsp;<input id="item2_5" type="checkbox" name="item2_5" checked="checked" value="z005"/><label for="item2_5">减少利息</label>
							</td>
							<td align="left">
								<input id="item2_6" type="checkbox" name="item2_6" checked="checked" value="xj2"/><label for="item2_6">减少小计</label>
							</td>
						</tr>
						<tr>
							<td align="left">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="item2_7" type="checkbox" name="item2_7" checked="checked" value="bjye"/><label for="item2_7">本金余额</label>
							</td>
							<td align="left">
								&nbsp;&nbsp;&nbsp;&nbsp;<input id="item2_9" type="checkbox" name="item2_8" checked="checked" value="lxye"/><label for="item2_8">利息余额</label>
							</td>
							<td align="left">
								<input id="item2_9" type="checkbox" name="item2_9" checked="checked" value="xj"/><label for="item2_9">余额小计</label>
							</td>
						</tr>
					</table>
				</td>
