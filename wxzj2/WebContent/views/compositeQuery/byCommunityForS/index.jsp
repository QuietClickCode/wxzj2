...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function do_search() {
			...
			$table.bootstrapTable('refresh',{url:"<c:url value='/byCommunityForS/list'/>"});
		}
		...
		function exportData(){
            ...
            var param = "xqbh="+xqbh+"&begindate="+begindate+"&enddate="+enddate+"&pzsh="+pzsh+"&cxlb="+cxlb+"&yhbh="+yhbh+"&xssy"+xssy;
            window.location.href="<c:url value='/byCommunityForS/exportByCommunityForS?'/>"+param;
		}
...
//			edit(row.bm);
		...
		function popUpModal_XQ_Bank() {
			...
			$.ajax({  
       			type: 'post',      
       			url: webPath+"byCommunityForS/getCommunity",  
       			data: {
            		yhbh : yhbh
       			},
       			cache: false,  
