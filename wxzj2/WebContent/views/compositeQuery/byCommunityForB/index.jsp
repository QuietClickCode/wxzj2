...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		// 查询方法
		function do_search() {
			$table.bootstrapTable('refresh',{url:"<c:url value='/byCommunityForB/list'/>"});
		}
		...
		function exportData(){
            ...
            var param = "yhbh="+yhbh+"&xmbm="+xmbm+"&xqbh="+xqbh+"&enddate="+enddate+"&pzsh="+pzsh+"&xssy="+xssy;
            window.location.href="<c:url value='/byCommunityForB/exportByCommunityForB?'/>"+param;
		}
		...
		function toPrint() {
			...
			var param = "yhbh="+yhbh+"&xmbm="+xmbm+"&xqbh="+xqbh+"&enddate="+enddate+"&pzsh="+pzsh+"&xssy="+xssy;
            var url = "<c:url value='/byCommunityForB/printpdfByCommunityForB?'/>"+param;
...
//			edit(row.bm);
		...
		function popUpModal_XQ_Bank() {
			var yhbh = $("#yhbh").val();
            	$.ajax({  
           			type: 'post',      
           			url: webPath+"byCommunityForB/getCommunity",  
           			data: {
                		yhbh : yhbh
           			},
           			cache: false,  
