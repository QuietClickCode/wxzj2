...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		function do_search() {
			...
			$table.bootstrapTable('refresh',{url:"<c:url value='/communityInterestF/list'/>"});
		}
		...
		function exportData(){
            ...
            yhbh= $.trim($("#yhbh").val());
            lsnd= $("#nd").val();
            var param = "bm="+bm+"&yhbh="+yhbh+"&lsnd="+escape(escape(lsnd));
            window.location.href="<c:url value='/communityInterestF/exportCommunityInterestF?'/>"+param;
		}
...
//			edit(row.bm);
		...
		function popUpModal_XQ_Bank() {
            ...
            $.ajax({  
       			type: 'post',      
       			url: webPath+"communityInterestF/getCommunity",  
       			data: {
            		yhbh : yhbh
       			},
       			cache: false,  
