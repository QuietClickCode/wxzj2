				...
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					...
					<tr class="formtabletr">
						...
						<td style="width: 7%; text-align: center;">
							<input type="checkbox" checked name="isAll" id="isAll" style="margin-top:7px;">&nbsp;&nbsp;显示所有业务
						</td>
						<td style="width: 18%">
		    ...
		    oTableInit.queryParams = function (params) {
	            ...
	            var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
	                ...
	                params: {
	                	...
	                	pzsh: $("#zt").val(),
	                	cxlb: $("#cxfs").val(),
//	                	xssy: $("#isAll").attr("checked") == true? "0": "1",//选中为0，未选中为1
		                xssy: i,
	                	yhbh: $("#yhbh").val()
		            }
	            };
		...
		// 查询方法
		function do_search() {
			$table.bootstrapTable('refresh',{url:"<c:url value='/querySummary/list'/>"});
		}
		...
		function exportData(){
        	...
        	yhbh= $("#yhbh").val();
        	xssy= i;
            var param = "yhbh="+yhbh+"&begindate="+begindate+"&enddate="+enddate+"&pzsh="+pzsh+"&cxlb="+cxlb+"&xssy="+xssy;
            window.location.href="<c:url value='/querySummary/exportQuerySummary?'/>"+param;
		}
