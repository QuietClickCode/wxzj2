...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		// 查询方法
		function do_search() {
			$table.bootstrapTable('refresh',{url:"<c:url value='/byBuildingForB/list'/>"});
		}
		...
		function exportData(){
            ...
            var param = "yhbh="+yhbh+"&xmbm="+xmbm+"&xqbh="+xqbh+"&lybh="+lybh+"&enddate="+enddate+"&pzsh="+pzsh+"&xssy="+xssy;
            window.location.href="<c:url value='/byBuildingForB/exportByBuildingForB?'/>"+param;
		}
		...
		function toPrint() {
			...
			var param = "yhbh="+yhbh+"&xmbm="+xmbm+"&xqbh="+xqbh+"&lybh="+lybh+"&enddate="+enddate+"&pzsh="+pzsh+"&xssy="+xssy;
            var url = "<c:url value='/byBuildingForB/pdfByBuildingForB?'/>"+param;
