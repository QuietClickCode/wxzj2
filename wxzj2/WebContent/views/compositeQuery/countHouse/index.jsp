...
<html lang="zh-CN">
	...
	<script type="text/javascript">
		...
		// 查询方法
		function do_search() {
			$table.bootstrapTable('refresh',{url:"<c:url value='/countHouse/list'/>"});
		}
		...
		function exportData(){
		    ...
		    var flag= i;
            var param = "begindate="+begindate+"&enddate="+enddate+"&xqbh="+xqbh+"&xmbm="+xmbm+"&flag="+flag;
            window.location.href="<c:url value='/countHouse/exportCountHouse?'/>"+param;
		}
