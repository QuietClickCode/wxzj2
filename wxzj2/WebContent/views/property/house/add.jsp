		...
		<div style="margin:0 auto; width:1000px;">
		     <table style="margin: 0; width: 100%">
		        <tr class="formtabletr">
		            ...
		            <td style="width: 18%">
		            	<input id="h002" name="h002" onchange="changeh002()" type="text" class="fifinput" value='${house.h002}'  style="width:85px;"/>
		            	<span style="display:inline;">&nbsp;层&nbsp;</span>
		            	<input id="h003" name="h003" onchange="changeh003()" type="text" class="fifinput" value='${house.h003}'  style="width:85px;"/>
		            </td>
		            <td style="width: 7%; text-align: center;">房&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号<font color="red"><b>*</b></font></td>
		            <td style="width: 18%">
		            	<input id="h005" name="h005" onchange="changeh005()" type="text" class="fifinput" value='${house.h005}'  style="width:200px;"/>
		            </td>
		        </tr>
		        <tr class="formtabletr">
