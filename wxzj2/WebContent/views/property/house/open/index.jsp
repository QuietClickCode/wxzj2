...
<html>
	...
	<body style="min-width:1100px;">
		<div class="rightinfo">
			<div class="tools">
				<form action="<c:url value='/house/open/list'/>" method="post" id="myForm">
			...
			<table class="tablelist">
				<thead>
					<tr>
						<th style="width: 3%"><input  type="checkbox"  value="" onclick="inverseCkb('ckbox',this)" /></th>
						<th style="width: 11%">房屋编号</th>
						<th style="width: 15%">业主姓名</th>
       					<th style="width: 5%">单元</th>
       					<th style="width: 5%">层</th>
       					<th style="width: 7%">房号</th>
       					<th style="width: 7%">建面</th>
       					<th style="width: 12%">交存标准</th>
       					<th style="width: 8%">房屋类型</th>
       					<th style="width: 8%">应交金额</th>
       					<th style="width: 15%">归集中心</th>
					</tr>
				</thead>
				<tbody>
					<c:if test="${!empty page.data }">
						<c:forEach items="${page.data}" var="house" varStatus="sta">
