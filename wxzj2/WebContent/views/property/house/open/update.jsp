		...
		$.ajax({  
			...
			success:function(data){ 
				...
				if (data == "0") {
		            ...
		            art.dialog.data('isCloseupdate', '0');		           
					art.dialog.close();
				} else if (data == "8") {
			...
			<div style="margin:0 auto; width:1000px;">
			     <table style="margin: 0; width: 100%">
			        <tr class="formtabletr">
			            ...
			            <td style="width: 18%">
			            	<input id="h001" name="h001" type="hidden" value='${house.h001}'>
			        ...
			        <tr class="formtabletr">
			            ...
			            <td style="width: 18%">
			            	...
			            	<input id="h052" name="h052" type="text" class="fifinput"  
			            	onmousedown="setZB();" style="width:80px;"/>
			            	<span style="display:inline;">&nbsp;Y&nbsp;</span>
			            	<input id="h053" name="h053" type="text" class="fifinput" 
			            	onmousedown="setZB();" style="width:80px;"/>
			            </td>
			        </tr>
			        <tr class="formtabletr">
