...
<html lang="zh-CN">
			...
			<form action="" method="post" id="myForm">
				<table style="margin: 0; width: 100%; border: solid 1px #ced9df">
					<tr class="formtabletr">
						<td style="width: 7%; text-align: center;">单位名称</td>
						<td style="width: 18%">
							<input name="mc" id="mc" type="text" class="dfinput" value="${_req.entity.mc}" style="width: 202px;"/>
						</td>
						<td style="width: 7%; text-align: center;">联系人</td>
						<td style="width: 18%">
							<input name="contactPerson" id="contactPerson" value="${_req.entity.contactPerson}" type="text" class="dfinput" style="width: 202px;"/>
						</td>
						<td style="width: 7%; text-align: center;">单位地址</td>
						<td style="width: 18%">
	...
	<script type="text/javascript">
		    ...
		    oTableInit.Init = function () {
		    	$(function () {
		    		$table.bootstrapTable({
						url: "<c:url value='/developer/list'/>",  // 请求后台的URL（*）
		...
		// 跳转到新增页面
		function toAdd(){
			window.location.href="<c:url value='/developer/toAdd'/>";
		}
		...
		function del(id) {
			art.dialog.confirm('是否删除当前记录?',function(){                       
				var url = "<c:url value='/developer/delete?bm='/>"+id;
		        location.href = url;
	    	});
		}
		...
		function batchDel() {
			...
			if (bms == null || bms == "") {
				...
				art.dialog.confirm('你确定要删除选中的'+i+'条数据吗？', function() {
					var url = webPath+"developer/batchDelete?bms="+bms;
			        location.href = url;
				});
			}
		}
