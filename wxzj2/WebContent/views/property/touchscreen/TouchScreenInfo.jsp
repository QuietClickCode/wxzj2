    ...
    <li><a href="#">触摸屏信息管理</a></li>
	    ...
	    <div class="formbody">
		    <div style="margin:0 auto; width:1000px;">
		        <br>
		        <ul class="formIf">
		            <li><label>编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label><input name="" type="text" class="fifinput" value="Encoding"  style="width:200px;"/></li>
		            <li><label>资料题目</label><input name="" type="text" class="fifinput" value="探究如何降低银河系基础设施建设与维护成本"  style="width:200px;"/></li>
		        	<li><label>上传日期</label>
		        	<input name="birthday" id="birthday" type="text" class="laydate-icon" value="2016-07-06"
		        ...
		        <br>
		         <ul class="formIf" style="margin-left: 320px">
		            <li><label>&nbsp;</label><a href="<c:url value='/touchscreen/index'/>"><input name="" type="button" class="fifbtn" value="保存"/></a></li>
		        </ul>
			</div>
		</div>
</body>
